...
import { Search, Plus, ImageIcon, Pencil, Ban, RotateCcw } from 'lucide-react'
...
import { useProductos, useCategorias, useActivarProducto, type Producto } from './api'
...
export default function ProductosPage() {
  ...
  const { data: productos, isLoading } = useProductos({ search: busqueda, categoria: categoriaFiltro })
          ...
          <TableBody>
            ...
            {productos?.results.map((producto) => (
              <TableRow key={producto.id}>
                ...
                <TableCell>{producto.unidad_medida_nombre ?? '—'}</TableCell>
                <TableCell>{producto.presentacion_nombre ?? '—'}</TableCell>
